...
public class selectPanel extends JPanel {
    ...
    public selectPanel(panelManager p, gameLogic g) {
        ...
        characterImageLabel = new JLabel(resizeImage(new ImageIcon(getClass().getResource(characterProfiles[currentIndex])),x,y));
        ...
        leftArrow.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                characterImageLabel.setIcon(resizeImage(new ImageIcon(getClass().getResource(characterProfiles[currentIndex])),x,y));
            }
        });
