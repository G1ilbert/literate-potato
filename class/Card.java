...
public class Card implements Effect{
	...
	public Card(int val,int t,String color){
		...
		f = new ImageIcon(getClass().getResource("/img/card/"+ color + "/" + val +".png"));
		
		//ImageIcon b = new ImageIcon("img\\card\\back\\back.png"); 
		ImageIcon b = new ImageIcon(getClass().getResource("/img/card/back/back.png"));
		//backgroundImage = new ImageIcon(getClass().getResource("/img/background/Bg4.png")).getImage();
