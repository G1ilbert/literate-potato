...
public class GamePanel extends JPanel {
    ...
    private void addCardToPlayedPanel(Card cardToPlay) {
        ...
        if (g.canPlay(cardToPlay)) {
        	...
        	if(cardToPlay.getColor().equals("wild_card")) {
        		p.setStatus(2);
        	}
    ...
    public void wild(String color) {
    	...
    	ImageIcon f = new ImageIcon(getClass().getResource("/img/card/"+ color +"_card/Blank_" + color + ".png"));
    	//ImageIcon f = new ImageIcon("img\\card\\" + color + "_card\\Blank_" + color + ".png");
    	//getClass().getResource("/img/card/back/back.png"));
